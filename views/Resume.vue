...
<div style="display: flex; height: 100%; flex-direction: column">
    <nav class="download-bar">
        <a href="/files/Resume-vikram.pdf" class="download" style="z-index: 10" download target="_blank">
        ...
        <a href="/files/Resume-vikram.pdf" class="download" style="z-index: 10" target="_blank">
            <span style="display: flex" class="border">
    ...
    <div class="frame" style="z-index: 99">
        <iframe class="frame" src="https://drive.google.com/file/d/1jz3xVTGFjfWiEC-IDhkm79OqeSr_iEJJ/view"></iframe>

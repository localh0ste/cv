...
<template>
  <title>Vikram Pawar - aka localh0ste </title>
  <meta name="author" content="Vikram Pawar">
  <meta name="description"
    content="As a passionate Cybersecurity enthusiast and current BTech student specializing in Cybersecurity, I am focused on gaining exposure and advancing in the field of Governance, Risk, and Compliance (GRC). With a strong commitment to developing my skills, I am preparing for the OSCP and CISA certifications. Eager to learn from industry professionals and collaborate on challenging projects, I am driven to contribute meaningfully to the cybersecurity landscape.">
  <div id="app">
...
export default {
  data() {
    const jsonld = {
      ...
      "@type": "Person",
      "name": ["Vikram Pawar", "localh0ste", "localh0ste", "localh0ste Vikram Pawar"],
      "image": "img/self.jpg",
      "jobTitle": ["Information Security", " grc", "Cyber Security"],
      "description": "As a passionate Cybersecurity enthusiast and current BTech student specializing in Cybersecurity, I am focused on gaining exposure and advancing in the field of Governance, Risk, and Compliance (GRC). With a strong commitment to developing my skills, I am preparing for the OSCP and CISA certifications. Eager to learn from industry professionals and collaborate on challenging projects, I am driven to contribute meaningfully to the cybersecurity landscape.",
      "url": "https://localh0ste.me",
      "sameAs": [
        "https://facebook.com/localh0ste",
        "https://twitter.com/localh0ste",
        "https://instagram.com/localh0ste",
        "https://youtube.com/@localh0ste",
        "https://twitch.tv/localh0ste",
        "https://linkedin.com/in/localh0ste",
        "https://github.com/localh0ste",
      ],

<template>
    ...
    <div class="topbar">
      ...
      <div class="socials">
        <a href="https://x.com/localh0ste" target="_blank">
          <div class="bar">
            <img class="social-image" src="@/assets/iPhone-Icons/x.webp" />
            <u>T</u>witter
          </div>
        </a>
        <a href="https://www.instagram.com/localh0ste/" target="_blank">
          <div class="bar">
            <img
              class="social-image"
        ...
        <a href="https://youtube.com/@localh0ste/" target="_blank">
          <div class="bar">
            <img
              class="social-image"
        ...
        <a href="https://discordapp.com/users/366971690279895040" target="_blank">
          <div class="bar">
            <img class="social-image" src="@/assets/iPhone-Icons/discord.png" />
            <u>D</u>iscord
          </div>
        </a>
        <a href="https://www.reddit.com/user/Spiritual-Tart-5245" target="_blank">
          <div class="bar">
        ...
        <a
          href="https://www.linkedin.com/in/localh0ste"
          target="_blank"
        >
          <div class="bar">
        ...
        <a href="https://github.com/localh0ste" target="_blank">
          <div class="bar">
        ...
        <a href="/files/Resume-vikram.pdf" target="_blank">
          <div class="bar">
